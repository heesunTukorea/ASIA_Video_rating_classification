...
# ]
    ...
    horror_candidates = [
        ...
        "A scene that evokes psychological fear and suffering",  # 심리적 공포와 고통이 느껴지는 장면
        "An image that induces tension and anxiety",  # 긴장감과 불안감을 유발하는 이미지
        "A scene where a character appears deeply frightened",  # 공포에 질린 등장인물이 등장하는 장면
        ...
        "A horror scene with extreme gore, blood, or body mutilation",  # 극단적인 고어, 유혈, 신체 훼손이 포함된 장면 (청소년 관람불가)
