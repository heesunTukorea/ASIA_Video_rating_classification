...
from classification_runner_def_ec2 import total_classification_run
...
if page == "":
    ...
    with col_center[1]:
        try:
            image = Image.open("st_img/메인이미지/메인이미지.png") 
...
# 🔹 등급별 색상 매핑
    ...
    # 🔹 연령 등급별 색상 및 아이콘 매핑
    rating_assets = {
        "전체관람가": {"color": "#2F9D27", "icon": "st_img/영등위png/연령등급/ALL.png"},
        "12세이상관람가": {"color": "#FFCD12", "icon": "st_img/영등위png/연령등급/12.png"},
        "15세이상관람가": {"color": "#F26F0D", "icon": "st_img/영등위png/연령등급/15.png"},
        "청소년관람불가": {"color": "#E60000", "icon": "st_img/영등위png/연령등급/18.png"},
        "제한상영가": {"color": "gray", "icon": None}  # 제한상영가 이미지 없을 경우 None
    }
    # 🔹 내용정보 아이콘 매핑
    icon_dir = "st_img/영등위png/내용정보" # 노트북
    icon_map = {
