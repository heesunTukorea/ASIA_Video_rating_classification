...
OUTPUT_FILE_PATH = "results/sexuality_text_results.json"  # 분석 결과 저장 경로
            ...
            response = client.chat.completions.create(  # 최신 API 호출 방식
                ...
                messages=[
                    ...
                    },
                    {
                        ...
                        "content": 
                         f"""
                            다음 대사에서 선정성이 있는지 JSON 형식으로 알려주세요. 한글로 대답해 주세요. 문장으로 대답해 주세요.
                            {{
                            "text": "대사 내용"
                            "is_sexuality: "False" 또는 "True"
                            "explanation": "선정성 여부에 대한 이유"                          
                            }}
                            대사: {text}
                            """}
                    ],
